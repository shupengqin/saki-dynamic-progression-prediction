...
FROM saki_sicdb.landmarks_raw
UNION ALL
SELECT 'eligible_landmarks', COUNT(*), COUNT(DISTINCT stay_id)
FROM saki_sicdb.landmarks
UNION ALL
...
FROM saki_sicdb.modeling_dataset
WHERE NOT (
    icu_intime <= sepsis_onset_offset
...
FROM saki_sicdb.modeling_dataset
WHERE landmark_offset + 172800 > icu_outtime;
